        ...
        if (e.key === "Enter") {
            ...
            filteredCourses.forEach(course => {
                ...
                row.innerHTML = `
                    ...
                    <td style="font-size: 12px;">${course.time}</td>
                    <td style="font-size: 12px;">${course.room}</td>
                    <td style="font-size: 12px;">${course.students}</td>
                    <td style="font-size: 12px;">${course.remark}</td>
                `;
